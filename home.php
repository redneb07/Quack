				...
				if (isset($_SESSION['u_id'])) {
					...
					echo '			
						<form class="navbar-header" action="includes/login.inc.php" method="POST">
							...
							<button type="button" class="alert" name="signup"><a class="acitve" ref="signup.php">Sign Up</a></button>
						</form>';
				}
			?>
      </div>
...
<footer class="container-fluid text-center">
  <p><a href="http://www.meiershane.net/SLC/">meiershane.net</a></p>
</footer>
