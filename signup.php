	...
	<div class="row content">
		...
		<div class="col-sm-8 text-left">
			...
			<form class="signup-form" action="includes/signup.inc.php" method="POST" enctype="multipart/form-data">
				...
				<input type="password" name="pwd" placeholder="Password">
				<input type="text" name="iname" placeholder="Image Name and Upload Profile Picture below">
				<input type="file" name="file" id="file" placeholder="Upload Profile Picture">
				<button type="submit" name="submit" class="alert">Sign Up</button>
			</form> 
			</br>
		</div>
		<div class="col-sm-2 sidenav">
